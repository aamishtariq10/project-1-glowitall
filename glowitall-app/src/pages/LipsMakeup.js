            ...
            <div className="filter-card mb-3">
              ...
              <div>
                <div className="random-products mb-3 d-flex gap-10">
                  <div className="w-50">
                    <img
                      src="https://media.istockphoto.com/id/477663679/photo/every-woman-has-a-favourite-shade.jpg?b=1&s=170667a&w=0&k=20&c=KaMxlCh3jPwMVTfYnQld8mywn8ox5kIJ9vA3NgEFXnY="
                      className="img-fluid"
                      alt="Lipstick"
                    />
                  </div>
