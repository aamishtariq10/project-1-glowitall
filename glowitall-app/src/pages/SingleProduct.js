...
const SingleProduct = () => {
  ...
  const props = {
    ...
    height: 600,
    zoomWidth: 600,
    img: productState?.images[0]?.url?productState?.images[0]?.url:"https://www.shutterstock.com/image-photo/lipstick-fashion-colorful-lipsticks-over-260nw-1017284011.jpg",
  };
              ...
              <div className="review-form py-4">
                <h4>Write A Review</h4>
                  ...
                  <div className="d-flex justify-content-end mt-3">
                    ...
                    className="button border-0" type='button'>Submit Review</button>
                  </div>
