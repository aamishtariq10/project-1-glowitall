        ...
        <div className="row">
          <div className="col-12">
            <div className="payment-card">
              ...
              <h7> <BiRadioCircle className="fs-7"/> Card <br/> <BiRadioCircle  className="fs-7"/> Cash On Delivery</h7>
              <p className="mt-3"> <RiArrowGoBackFill className="fs-7"/> Return To Information</p>
              <div>
